...
export const achievementTypeEnum = pgEnum("achievement_type", ["first_weekly_finisher", "weekly_leaderboard", "monthly_leaderboard", "perfect_week", "lifetime_milestone", "task_streak", "star_collector", "legacy_collector"]);
