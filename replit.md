...
- **Gamification Features**: Monthly leaderboards with optional member exclusion, unlockable character skins across 9 themed collections (72 total skins: Starter Heroes, Elite Heroes, Dinosaur Heroes, Magical Princess World, Space Explorers, Cute Animals, Dino Adventure, Ballerina Dreams, Superhero Squad) with balanced point progression (0-4500 points, 60-point increments). Each new collection (tiers 4-9) features exactly 3 skins with bonus points (10-30 range) for extra progression rewards. Skins alternate between girls and boys themes. Points system tracks `totalEarned`, `totalPoints`, `weeklyPoints`, and `monthlyPoints`. Custom recurring tasks and factory reset option available.
