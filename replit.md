...
- **Account Setup Flow**: After a successful registration, the family setup screen highlights the next step, pre-fills the user's display name, and suggests a family name to make first-time setup smoother.
