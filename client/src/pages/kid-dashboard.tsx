      ...
      <div className="transition-transform duration-200 hover:-translate-y-0.5 active:scale-[0.98]">
        <Card className={`p-4 transition-colors border-2 rounded-2xl ${
          ...
          <div className="flex items-center gap-4">
            <div className={`flex-shrink-0 h-16 w-16 rounded-2xl flex items-center justify-center p-1.5 ${
              isReady ? "bg-primary/20" : "bg-primary/10"
            }`}>
              <RewardIconDisplay icon={reward.iconEmoji} imgClassName="w-full h-full object-contain drop-shadow-sm" textClassName="text-5xl leading-none" />
            </div>
    ...
    <div className="min-h-dvh">
      ...
      <div className="lg:col-span-2 space-y-8 min-w-0 overflow-hidden">
        ...
        {goals.filter(g => g.isActive).length > 0 && (
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              <img src={familyGoalsIcon} alt="" className="h-36 w-36 object-contain flex-shrink-0 drop-shadow-sm -my-6" />
              <h2 className="text-2xl font-bold text-white" style={{ fontFamily: "Fredoka, sans-serif", textShadow: "0 2px 4px rgba(0,0,0,0.8), 0 4px 12px rgba(0,0,0,0.6), 0 0 20px rgba(0,0,0,0.4)" }}>
